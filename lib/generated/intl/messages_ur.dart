...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "Add_To_Library":
            MessageLookupByLibrary.simpleMessage("لائبریری میں شامل کریں"),
        "Add_To_Playlist":
            MessageLookupByLibrary.simpleMessage("پلے لسٹ میں شامل کریں"),
        "Add_To_Queue":
        ...
        "Audio_And_Playback":
            MessageLookupByLibrary.simpleMessage("آڈیو اور پلے بیک"),
        "Backup": MessageLookupByLibrary.simpleMessage("بیک اپ"),
        "Backup_And_Restore":
            MessageLookupByLibrary.simpleMessage("بیک اپ اور بحالی"),
        ...
        "Battery_Optimisation_title":
            MessageLookupByLibrary.simpleMessage("بیٹری کی اصلاح کا پتہ چلا"),
        "Bug_Report": MessageLookupByLibrary.simpleMessage("بگ رپورٹ"),
        "Buy_Me_A_Coffee":
            MessageLookupByLibrary.simpleMessage("مجھے ایک کافی خریدیں"),
        "Cancel": MessageLookupByLibrary.simpleMessage("منسوخ کریں"),
        "Check_For_Update":
            MessageLookupByLibrary.simpleMessage("اپ ڈیٹ کے لئے چیک کریں"),
        ...
        "Copied_To_Clipboard":
            MessageLookupByLibrary.simpleMessage("کلپ بورڈ پر کاپی کر دیا گیا"),
        "Country": MessageLookupByLibrary.simpleMessage("ملک"),
        "Create": MessageLookupByLibrary.simpleMessage("بنائیں"),
        "Create_Playlist":
            MessageLookupByLibrary.simpleMessage("پلے لسٹ بنائیں"),
        "DOwnload_Quality":
            MessageLookupByLibrary.simpleMessage("ڈاؤن لوڈ کوالٹی"),
        ...
        "Delete_Playback_History":
            MessageLookupByLibrary.simpleMessage("پلے بیک ہسٹری کو حذف کریں"),
        "Delete_Playback_History_Confirm_Message":
            MessageLookupByLibrary.simpleMessage(
                "کیا آپ واقعی پلے بیک ہسٹری کو حذف کرنا چاہتے ہیں؟"),
        "Delete_Search_History":
            MessageLookupByLibrary.simpleMessage("تلاش کی ہسٹری کو حذف کریں"),
        ...
        "Donate_Message":
            MessageLookupByLibrary.simpleMessage("گیاون کی ترقی کی حمایت کریں"),
        ...
        "Enable_Equalizer":
            MessageLookupByLibrary.simpleMessage("ایکوالائزر کو فعال کریں"),
        "Enable_Playback_History":
            MessageLookupByLibrary.simpleMessage("پلے بیک ہسٹری کو فعال کریں"),
        "Enable_Search_History":
            MessageLookupByLibrary.simpleMessage("تلاش کی ہسٹری کو فعال کریں"),
        "Enter_Visitor_Id":
            MessageLookupByLibrary.simpleMessage("وزیٹر آئی ڈی درج کریں"),
        "Equalizer": MessageLookupByLibrary.simpleMessage("ایکولائزر"),
        "Favourites": MessageLookupByLibrary.simpleMessage("پسندیدہ"),
        "Feature_Request":
            MessageLookupByLibrary.simpleMessage("خصوصیت کی درخواست"),
        ...
        "Import_Playlist":
            MessageLookupByLibrary.simpleMessage("پلے لسٹ درآمد کریں"),
        "Jhelum_Corp": MessageLookupByLibrary.simpleMessage("جہلم کارپ"),
        "Language": MessageLookupByLibrary.simpleMessage("زبان"),
        "Library": MessageLookupByLibrary.simpleMessage("محفوظ کردہ"),
        "Loudness_And_Equalizer":
            MessageLookupByLibrary.simpleMessage("لاؤڈنس اور ایکوالائزر"),
        "Loudness_Enhancer":
            MessageLookupByLibrary.simpleMessage("لاؤڈنس انہینسر"),
        "Low": MessageLookupByLibrary.simpleMessage("کم"),
        "Made_In_Kashmir":
            MessageLookupByLibrary.simpleMessage("کشمیر میں بنایا گیا"),
        ...
        "Pay_With_UPI":
            MessageLookupByLibrary.simpleMessage("یو پی آئی کے ساتھ ادائیگی"),
        "Payment_Methods":
            MessageLookupByLibrary.simpleMessage("ادائیگی کے طریقے"),
        "Personalised_Content":
            MessageLookupByLibrary.simpleMessage("ذاتی بنایا گیا مواد"),
        "Play_Next": MessageLookupByLibrary.simpleMessage("اگلا چلائیں"),
        "Playback_History_Deleted":
            MessageLookupByLibrary.simpleMessage("پلے بیک ہسٹری حذف کر دی گئی"),
        "Playlist": MessageLookupByLibrary.simpleMessage("محفوظ کردہ"),
        ...
        "Remove_From_Favourites":
            MessageLookupByLibrary.simpleMessage("پسندیدہ سے ہٹائیں"),
        "Remove_From_Library":
            MessageLookupByLibrary.simpleMessage("لائبریری سے ہٹائیں"),
        ...
        "Rename_Playlist":
            MessageLookupByLibrary.simpleMessage("پلے لسٹ کا نام تبدیل کریں"),
        ...
        "Search_History_Deleted":
            MessageLookupByLibrary.simpleMessage("تلاش کی ہسٹری حذف کر دی گئی"),
        "Search_Settings":
            MessageLookupByLibrary.simpleMessage("تلاش کی ترتیبات"),
        "Search_shreeya":
            MessageLookupByLibrary.simpleMessage("گیاون تلاش کریں"),
        "Select_Backup":
            MessageLookupByLibrary.simpleMessage("بیک اپ منتخب کریں"),
        ...
        "Skip_Silence":
            MessageLookupByLibrary.simpleMessage("خاموشی کو چھوڑ دیں"),
        ...
        "Streaming_Quality":
            MessageLookupByLibrary.simpleMessage("سٹریمنگ کوالٹی"),
        "Subscriptions": MessageLookupByLibrary.simpleMessage("سبسکرپشنز"),
        "Support_Me_On_Kofi":
            MessageLookupByLibrary.simpleMessage("کوفی پر مجھے سپورٹ کریں"),
        ...
        "nSongs": m0,
        "shreeya": MessageLookupByLibrary.simpleMessage("گیاون")
      };
}
