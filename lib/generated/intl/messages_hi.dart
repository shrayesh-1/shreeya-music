...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "Add_To_Favourites":
            MessageLookupByLibrary.simpleMessage("पसंदीदा में जोड़ें"),
        "Add_To_Library":
            MessageLookupByLibrary.simpleMessage("लाइब्रेरी में जोड़ें"),
        "Add_To_Playlist":
            MessageLookupByLibrary.simpleMessage("प्लेलिस्ट में जोड़ें"),
        ...
        "Audio_And_Playback":
            MessageLookupByLibrary.simpleMessage("ऑडियो और प्लेबैक"),
        "Backup": MessageLookupByLibrary.simpleMessage("बैकअप"),
        "Backup_And_Restore":
            MessageLookupByLibrary.simpleMessage("बैकअप और पुनर्स्थापना"),
        ...
        "Battery_Optimisation_title":
            MessageLookupByLibrary.simpleMessage("बैटरी ऑप्टिमाइजेशन पता चला"),
        "Bug_Report": MessageLookupByLibrary.simpleMessage("बग रिपोर्ट"),
        "Buy_Me_A_Coffee":
            MessageLookupByLibrary.simpleMessage("मुझे एक कॉफी खरीदें"),
        "Cancel": MessageLookupByLibrary.simpleMessage("रद्द करें"),
        "Check_For_Update":
            MessageLookupByLibrary.simpleMessage("अपडेट के लिए जाँचें"),
        ...
        "Enable_Equalizer":
            MessageLookupByLibrary.simpleMessage("इक्वलाइज़र सक्षम करें"),
        "Enable_Playback_History":
            MessageLookupByLibrary.simpleMessage("प्लेबैक इतिहास सक्षम करें"),
        "Enable_Search_History":
            MessageLookupByLibrary.simpleMessage("खोज इतिहास सक्षम करें"),
        "Enter_Visitor_Id":
            MessageLookupByLibrary.simpleMessage("विज़िटर आईडी दर्ज करें"),
        ...
        "Import_Playlist":
            MessageLookupByLibrary.simpleMessage("प्लेलिस्ट आयात करें"),
        "Jhelum_Corp": MessageLookupByLibrary.simpleMessage("झेलम कॉर्प"),
        "Language": MessageLookupByLibrary.simpleMessage("भाषा"),
        "Library": MessageLookupByLibrary.simpleMessage("सहेजे गए"),
        "Loudness_And_Equalizer":
            MessageLookupByLibrary.simpleMessage("लाउडनेस और इक्वलाइज़र"),
        "Loudness_Enhancer":
            MessageLookupByLibrary.simpleMessage("लाउडनेस एन्हांसर"),
        "Low": MessageLookupByLibrary.simpleMessage("निम्न"),
        "Made_In_Kashmir":
            MessageLookupByLibrary.simpleMessage("कश्मीर में बना"),
        ...
        "Pay_With_UPI":
            MessageLookupByLibrary.simpleMessage("UPI के साथ भुगतान करें"),
        "Payment_Methods":
            MessageLookupByLibrary.simpleMessage("भुगतान के तरीके"),
        "Personalised_Content":
            MessageLookupByLibrary.simpleMessage("व्यक्तिगत सामग्री"),
        "Play_Next": MessageLookupByLibrary.simpleMessage("अगला चलाएं"),
        "Playback_History_Deleted":
            MessageLookupByLibrary.simpleMessage("प्लेबैक इतिहास हटाया गया"),
        "Playlist": MessageLookupByLibrary.simpleMessage("Playlist"),
        "Playlist_Name":
            MessageLookupByLibrary.simpleMessage("प्लेलिस्ट का नाम"),
        ...
        "Remove_From_Favourites":
            MessageLookupByLibrary.simpleMessage("पसंदीदा से हटाएं"),
        "Remove_From_Library":
            MessageLookupByLibrary.simpleMessage("लाइब्रेरी से हटाएं"),
        ...
        "Rename_Playlist":
            MessageLookupByLibrary.simpleMessage("प्लेलिस्ट का नाम बदलें"),
        "Reset_Visitor_Id":
            MessageLookupByLibrary.simpleMessage("विज़िटर आईडी रीसेट करें"),
        "Restore": MessageLookupByLibrary.simpleMessage("पुनर्स्थापित"),
        "Search_History_Deleted":
            MessageLookupByLibrary.simpleMessage("खोज इतिहास हटाया गया"),
        "Search_Settings": MessageLookupByLibrary.simpleMessage("खोज सेटिंग्स"),
        "Search_shreeya": MessageLookupByLibrary.simpleMessage("Search Music"),
        ...
        "Streaming_Quality":
            MessageLookupByLibrary.simpleMessage("स्ट्रीमिंग गुणवत्ता"),
        "Subscriptions": MessageLookupByLibrary.simpleMessage("सब्सक्रिप्शन"),
        "Support_Me_On_Kofi":
            MessageLookupByLibrary.simpleMessage("को-फ़ी पर मुझे समर्थन दें"),
        ...
        "nSongs": m0,
        "shreeya": MessageLookupByLibrary.simpleMessage("ग्यावुन")
      };
}
