...
void main() async {
  ...
  if (Platform.isAndroid) {
    await JustAudioBackground.init(
      androidNotificationChannelId: 'com.shreeya.dahal.audio',
  ...
  if (Platform.isWindows) {
    ...
    JustAudioMediaKit.title = 'Shrayesh Music';
...
class shreeya extends StatelessWidget {
  const shreeya({super.key});
  @override
